  ...
  const currentUrl = router.asPath;
   ...
   return (
      ...
      <div>
         ...
         <aside id="default-sidebar" className="top-0 bg-white left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0 text-black" aria-label="Sidebar">
